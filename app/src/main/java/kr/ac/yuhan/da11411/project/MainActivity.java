package kr.ac.yuhan.da11411.project;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText[] gong = new EditText[3];
    Integer[] gong_id = {R.id.gong_Midterm,R.id.gong_Final,R.id.gong_Project};

    EditText[] db = new EditText[3];
    Integer[] db_id = {R.id.db_Midterm,R.id.db_Final,R.id.db_Project};

    TextView[] result_t = new TextView[3];
    Integer[] result_id = {R.id.db_result, R.id.mobile_result, R.id.gong_result};

    EditText[] check = new EditText[3];
    Integer[] check_id = {R.id.db_check, R.id.mobile_check, R.id.gong_check};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            gong[i] = (EditText) findViewById(gong_id[i]);
        }
        for (int i = 0; i < 3; i++) {
    ...
    View.OnClickListener btnL = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                result[2] = result[2] + Integer.parseInt(gong[i].getText().toString());
            }
